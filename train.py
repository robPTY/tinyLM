...
def make_collate_fn(tokenizer: Tokenizer, max_len: int):
...
def main():
    ...
    train_loader = DataLoader(training_set, batch_size=config.BATCH_SIZE, shuffle=True, collate_fn=make_collate_fn(tokenizer, config.MAX_SEQ_LEN))
